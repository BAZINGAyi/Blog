...
<img src="{{site.baseurl}}/assets/img/7C588725-B31D-4A12-A526-AC3D0B3BEF5C.jpeg"  alt="example1" width="40%"/>
...
<img src="{{site.baseurl}}/assets/img/5170B5B3-55A2-4E53-98C1-8DDD5A18E3E5.jpeg"  alt="example2" width="40%"/>

然后开始我们的分析了, `b.txt` 和 `a.txt` 会在工作区还是暂存区还是仓库中呢？并且 `a.txt `的内容是什么呢？

<img src="{{site.baseurl}}/assets/img/D5B90E80-F5FE-4647-BDC2-E1F3D94BD24F.png"  alt="example3" width="40%"/>

**正如图中显示的那样,** `a.txt`,`b.txt` **均在工作区,接着可以使用** `git diff` 用来查看更加详细的信息如下图

<img src="{{site.baseurl}}/assets/img/C6033C88-7DFA-48A4-930A-36AA503B94AA.png"  alt="example4" width="40%"/>
