...
`git reset --mixed HEAD~1` ,各状态如图

<img src="{{site.baseurl}}/assets/img/CF51F610-9E5A-45E2-AEC2-E7833DE70817.png"  alt="reset-mixed" width="40%"/>

`git reset --softed HEAD~1` ,各状态如图。

<img src="{{site.baseurl}}/assets/img/reset-soft.png"  alt="reset-soft" width="40%"/>

`git reset --hard HEAD~1` ,各状态如图。

<img src="{{site.baseurl}}/assets/img/48E7F6BD-CCF4-476A-AD0D-DDB3EA0CEEC6.png"  alt="reset-hard" width="40%"/>
